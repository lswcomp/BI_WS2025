...
import (
	...
	"github.com/lswcomp/BI_WS2025/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "b35368ab.bi-ws2025.de",
	...
	if err := (&controller.ObservationReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "Observation")
		os.Exit(1)
	}
